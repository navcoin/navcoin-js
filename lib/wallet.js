...
class WalletFile extends EventEmitter {
  ...
  async UpdateDotNav(name, subdomain, key, value, spendingPassword) {
    ...
    return await this.xNavCreateTransaction(bitcore.Script.fromHex("6ac1"), first ? consensus[22].value : 0, "", spendingPassword, false, new Buffer(new Uint8Array(32)), -1, vData, privk);
  }
